...
export function Hero() {
  return (
    <section id="home" className="relative overflow-hidden bg-gradient-hero">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 pt-8 sm:pt-16 lg:pt-20 pb-10 sm:pb-24 lg:pb-32 grid md:grid-cols-12 gap-8 lg:gap-12 items-center">
        <motion.div
          initial={false}
        ...
        >
          ...
          <div className="mt-6 sm:mt-9 flex flex-wrap gap-3 sm:gap-4">
            <Button asChild size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90 font-semibold rounded-full px-7 shadow-glow-navy">
              <a href="#results"><Trophy className="mr-2 w-4 h-4" /> Meet Our Stars <ArrowRight className="ml-2 w-4 h-4" /></a>
            </Button>
        ...
        >
          <div className="relative lift max-w-sm mx-auto md:max-w-none">
            ...
            <div className="relative bg-card rounded-3xl p-4 sm:p-6 shadow-3d border border-border">
              <div className="aspect-[4/5] rounded-2xl bg-gradient-to-br from-primary/8 to-secondary/15 border border-border flex items-center justify-center overflow-hidden relative">
                ...
                <div className="text-center p-6 sm:p-8 relative">
                  <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-primary mx-auto mb-3 sm:mb-4 flex items-center justify-center text-2xl sm:text-3xl text-primary-foreground float ring-4 ring-secondary/30">
                    👤
                  </div>
                  <p className="text-xs sm:text-sm text-muted-foreground italic">[ Founder / Director Photo ]</p>
              ...
              <div className="mt-4 sm:mt-5 flex items-end justify-between">
                <div>
                  ...
                  <div className="text-lg sm:text-xl font-display font-semibold mt-1 text-primary">Dropper's Club</div>
                </div>
